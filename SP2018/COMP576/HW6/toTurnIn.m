...
%A = A/w;
%% Console Output
fprintf('Printing Quaternion:\n')
disp(q)
fprintf('Printing Rotation Matrix:\n')
disp(R)
fprintf('Printing Center of Mass:\n')
disp(d)
[V,D] = eig(A);
[D,I] = sort(diag(D),'ascend');
V = V(:,I);
fprintf('Printing sorted eigenvectors, sorted by ascending order of corresponding eigenvalues:\n')
disp(V)
fprintf('Printing ratio of eigenvalues (sorted) to radii:\n')
disp(D./r')
fprintf('Your code forgets to divide A by sum of pixels.\n')
A_ = A/w;
[V,D] = eig(A_);
[D,I] = sort(diag(D),'ascend');
fprintf('Now displays the eigenvalues of correct A.\n')
disp(D)
fprintf('Printing ratio of eigenvalues of correct A to radii:\n')
disp(D./r')
fprintf('Printing ratio of square root of eigenvalues of correct A to radii:\n')
disp(sqrt(D)./r')

%% Output Images
imwrite(mat2gray(z_slice),'z_slice.jpg')
imwrite(mat2gray(z_rotated_slice),'z_rotated_slice.jpg')
