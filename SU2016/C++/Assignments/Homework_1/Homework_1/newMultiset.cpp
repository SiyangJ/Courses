...
Multiset::Multiset()
{
    ...
    itemArr=new Item[DEFAULT_MAX_ITEMS];
}
...
Multiset& Multiset::operator=(const Multiset& other)
{
    ...
    this->sizeOfArr=other.sizeOfArr;
    this->limit=other.limit;
    this->itemArr=new Item[this->limit];
    for (int i=0; i<sizeOfArr; i++)
        this->itemArr[i]=other.itemArr[i];
    return *this;
}
...
bool Multiset::insert(const ItemType& value)
{
    ...
    if (sizeOfArr==this->limit) return 0;
...
{
    Item* temp=other.itemArr;
    other.itemArr=this->itemArr;
    this->itemArr=temp;
    int temp2;
    temp2=other.sizeOfArr;
    other.sizeOfArr=this->sizeOfArr;
    this->sizeOfArr=temp2;
    temp2=other.limit;
...
void Multiset::copyIntoOtherMultiset(Multiset &other)
{
    ...
    for (int i=0; i<this->sizeOfArr; i++)
    {
        ...
        {
            if (other.sizeOfArr==other.limit) continue;
